<aside id="search" class="wcf-container wcf-search">
	<img src="{icon size='M'}search2{/icon}" alt="" title="{lang}wcf.global.button.search{/lang}" class="wcf-containerIcon wcf-searchButton jsCollapsible jsTooltip" />
